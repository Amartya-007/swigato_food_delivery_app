...
from gui_Light import (
    ...
    TEXT_COLOR, ICON_PATH, set_swigato_icon, safe_focus, center_window, ERROR_COLOR, SUCCESS_COLOR, DISABLED_BUTTON_COLOR, BUTTON_TEXT_COLOR
)
...
class SwigatoDialog(ctk.CTkToplevel):
    ...
    def show_error(parent, title, message):
        SwigatoDialog(parent, title=title, message=message, buttons=[{"text": "OK", "fg_color": ERROR_COLOR}])

    @staticmethod
    def show_warning(parent, title, message):
        SwigatoDialog(parent, title=title, message=message, buttons=[{"text": "OK", "fg_color": SUCCESS_COLOR}])
    ...
    def ask_yes_no(parent, title, message):
        ...
        dialog = SwigatoDialog(
            ...
            buttons=[
                ...
                {"text": "No", "fg_color": DISABLED_BUTTON_COLOR, "command": on_no}
            ]
        )

...
class AdminUsersScreen(ctk.CTkFrame): # Renamed class
    ...
    def _open_edit_user_dialog(self, user_id_to_edit):
        ...
        user_to_edit_obj = User.get_by_id(user_id_to_edit) # Fetch user object from DB        if not user_to_edit_obj:
        ...
        safe_focus(self.username_entry_edit)    def _confirm_delete_user_from_dialog(self):
    ...
    def _confirm_delete_user(self, user_id_to_delete, username_for_dialog):
        user_to_delete_obj = User.get_by_id(user_id_to_delete)        if not user_to_delete_obj:
    ...
    def _delete_user(self, user_id_to_delete, username_for_logging):
        if User.delete_by_username(username_for_logging):
            ...
            self._load_and_display_users()        else:
            ...
            self._load_and_display_users()    def _toggle_admin_status(self, user_id_to_toggle): 
